angular.module('starter.controllers', [])
  ...
  .controller('HomeCtrl', function($scope, $ionicPlatform, $ionicPopup, $ionicModal, $ionicLoading) {
    ...
    $scope.printerModels = [{
      ...
      {
        text: "SM-S210i StarPRNT",
        emulation: "StarPRNT"
      },
      {
        text: "SM-S220i StarPRNT",
        emulation: "StarPRNT"
      },
      {
        text: "SM-S230i StarPRNT",
        emulation: "StarPRNT"
      },
      {
        text: "SM-T300i/T300 StarPRNT",
        emulation: "StarPRNT"
      },
      {
        text: "SM-T400i StarPRNT",
        emulation: "StarPRNT"
      }
    ]
    ...
    $scope.printerTypePopup = function() {
      ...
      myPopup.then(function() {
        $ionicLoading.show({
          template: '<ion-spinner></ion-spinner> Communicating...'
        });
